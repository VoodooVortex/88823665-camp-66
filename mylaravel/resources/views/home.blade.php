                        ...
                        <div class="direct-chat-contacts">
                            <ul class="contacts-list">
                                <li>
                                    <a href="#">
                                        <img class="contacts-list-img"
                                            src="{{ url('public/assets/img/user1-128x128.jpg') }}" alt="User Avatar" />
                                ...
                                <li>
                                    <a href="#">
                                        <img class="contacts-list-img"
                                            src="{{ url('public/assets/img/user7-128x128.jpg') }}" alt="User Avatar" />
                                        <div class="contacts-list-info">
                                            <span class="contacts-list-name">
                                                Sarah Doe
                                ...
                                <li>
                                    <a href="#">
                                        <img class="contacts-list-img"
                                            src="{{ url('public/assets/img/user3-128x128.jpg') }}" alt="User Avatar" />
                                        <div class="contacts-list-info">
                                            <span class="contacts-list-name">
                                                Nadia Jolie
                                ...
                                <li>
                                    <a href="#">
                                        <img class="contacts-list-img"
                                            src="{{ url('public/assets/img/user5-128x128.jpg') }}" alt="User Avatar" />
                                        <div class="contacts-list-info">
                                            <span class="contacts-list-name">
                                                Nora S. Vans
                                ...
                                <li>
                                    <a href="#">
                                        <img class="contacts-list-img"
                                            src="{{ url('public/assets/img/user6-128x128.jpg') }}" alt="User Avatar" />
                                        <div class="contacts-list-info">
                                            <span class="contacts-list-name">
                                                John K.
                                ...
                                <li>
                                    <a href="#">
                                        <img class="contacts-list-img"
                                            src="{{ url('public/assets/img/user8-128x128.jpg') }}" alt="User Avatar" />
                                        <div class="contacts-list-info">
                                            <span class="contacts-list-name">
                                                Kenneth M.
